...
buster.testCase('_swipe',
{
  setUp: common.setUp,

  'Invokes _triggerEvents with list of events': function(done)
  {
    var eventsList = ['touchstart', ['touchmove', 'touchend']]
    ...
    // invoke test subject
    this.testObject._swipe(target, eventCoordinates, callback);
    ...
    setTimeout(function()
    {
      ...
      assert.calledWith(this.testObject._triggerEvents, target, eventsList, target, eventCoordinates, callback);
  ...
  'Works with selectors beside jQuery object': function(done)
  {
    ...
    // invoke test subject
    this.testObject._swipe(selector, eventCoordinates, callback);
